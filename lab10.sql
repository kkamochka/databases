...
create or replace function complex_calculation(input_num int, input_str varchar)
returns text as $$
declare
    num_result int;
    str_result varchar;
...
begin
    ...
    begin
        ...
        declare
            squared_num int;
        begin
            squared_num := input_num * input_num;
            num_result := squared_num + 20;
        end NUMERIC_BLOCK;
        ...
        begin
            ...
            str_result := reversed_str || ' COMPLEX';
        end STRING_BLOCK;

        final_result := 'Numeric Result: ' || num_result || ', String Result: ' || str_result;
    end MAIN;
